...
$GLOBALS['TL_LANG']['composer_client']['php_version']                   = 'PHP Version <strong>PHP %1$s</strong> oder neuer wird vorrausgesetzt. Deine Installation läuft mit PHP Version <strong>%1$s</strong>.<br>Bitte aktualisiere deine PHP Version.';
