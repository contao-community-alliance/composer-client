...
$GLOBALS['TL_LANG']['composer_client']['install_headline']              = 'Details zu %s';
...
$GLOBALS['TL_LANG']['composer_client']['search_placeholder']            = 'Pakete, Stichwörter oder Autoren finden';
