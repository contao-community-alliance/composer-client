...
$GLOBALS['TL_LANG']['composer_client']['widget_prefer_stable']['0']     = 'Stabile Pakete bevorzugen';
...
$GLOBALS['TL_LANG']['composer_client']['widget_preferred_install']['1'] = 'Wählen Sie hier, ob die Quellen (benötigt GIT, Mercurial oder SVN) oder Paketarchive (funktioniert immer) installiert werden sollen.';
