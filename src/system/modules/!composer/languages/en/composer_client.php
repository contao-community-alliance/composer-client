...
$GLOBALS['TL_LANG']['composer_client']['php_version']           = 'PHP version <strong>PHP %1$s</strong> or newer is required. Your system runs with PHP version <strong>%1$s</strong>.<br>Please upgrade your PHP.';
