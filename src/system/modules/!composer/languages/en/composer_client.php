...
$GLOBALS['TL_LANG']['composer_client']['php_version']           = 'PHP version <strong>PHP %1$s</strong> or newer is required. Your system runs with PHP version <strong>%2$s</strong>.<br>Please upgrade your PHP.';
...
$GLOBALS['TL_LANG']['composer_client']['incompatiblePackageLong']  = 'This package version is not compatible with this Contao version!';
